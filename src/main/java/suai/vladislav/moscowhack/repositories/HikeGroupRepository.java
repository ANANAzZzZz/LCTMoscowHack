...
public interface HikeGroupRepository extends JpaRepository<HikeGroup, Integer> {
...
//    @Query(value = "SELECT h FROM HikeGroup h WHERE h.usersInHikeGroups. = ?1")
    List<HikeGroup> findAllByUsersInHikeGroupsContaining(Integer id);
}
